...
<head>
    ...
    <style>
        ...
        .light-mode .container {
            background-color: #f0f0f0; /* Fond clair pour le conteneur */
            color: black; /* Texte en noir pour le conteneur */
        }
        ...
        .light-mode .content {
            ...
            color: black; /* Texte en noir pour le contenu */
        }
        /* Style des boutons */
        .content button {
        ...
        .light-mode .card {
            background-color: #e0e0e0; /* Fond clair pour les cartes */
            color: black; /* Texte en noir pour les cartes */
        }
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <button onclick="window.location.href='ajouter_themes.php'">Ajouter les thèmes</button>
